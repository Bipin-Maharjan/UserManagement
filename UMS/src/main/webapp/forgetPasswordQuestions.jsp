...
<div class="mx-3">
  ...
  <div class="container mt-lg-3 pr-lg-5 pl-lg-2">
    <div class="b_formWidth" style="width: 50%; margin-right: auto; margin-left: auto;">
      <form action="<%= request.getContextPath() %>/account/checkquestions/" autocomplete="off" method="POST" class="py-4 pr-lg-5 px-4 border rounded shadow-lg" style="background-color: #e1e2e2;">
